...
router.delete('/logs/bulk', authorize('SUPER_ADMIN'), subscriptionController.deleteLogsBulk);
router.delete('/logs/:id', authorize('SUPER_ADMIN'), subscriptionController.deleteLog);
