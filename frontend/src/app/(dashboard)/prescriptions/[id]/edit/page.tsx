    ...
    <div className="space-y-6 pb-20">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button type="button" onClick={() => router.push(`/prescriptions/${id}`)} className="p-2.5 rounded-xl hover:bg-gray-200/50 dark:hover:bg-gray-800/50 transition-colors">
          ...
          <section className="bg-white dark:bg-gray-900 rounded-xl p-4 shadow-sm border-l-4 border-l-blue-400 border border-blue-200/30 dark:border-blue-800/30">
            ...
            {watchPatientId && selectedPatient ? (
              <div className={cn("flex items-center gap-5", errors.patientId ? "p-3 rounded-xl ring-2 ring-red-500" : "")}>
                ...
                <button type="button" onClick={() => { setValue('patientId', ''); setSelectedPatient(null); setPatientSearch(''); }} className="p-2 rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                  <X className="h-5 w-5" />
                </button>
              </div>
            ) : (
                ...
                <div className="grid grid-cols-12 gap-2 sm:gap-3 items-start">
                  ...
                  <div className="col-span-12 sm:col-span-4 md:col-span-2 space-y-1.5">
                    ...
                    <datalist id={`freq-suggestions-${i}`}>
                      ...
                      <option value="প্রতি ২ ঘণ্টা" /><option value="প্রতি ৪ ঘণ্টা" /><option value="প্রতি ৬ ঘণ্টা" />
                      <option value="প্রতি ৮ ঘণ্টা" /><option value="প্রতি ১২ ঘণ্টা" /><option value="প্রতি ২৪ ঘণ্টা" />
