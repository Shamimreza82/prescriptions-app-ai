                ...
                w.document.write(`
                  ...
                  <body>
                    ...
                    <div class="footer">
                      ...
                      <div style="text-align:right;"><p style="margin:0;font-size:11px;font-weight:bold;">${platform?.name || 'MediCloud'}</p><p style="margin:0;font-size:11px;color:#999;">${platform?.address || ''}</p><p style="margin:0;font-size:11px;color:#999;">${platform?.phone || ''}</p></div>
                    </div>
